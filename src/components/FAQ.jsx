...
const FAQ = () => {
  ...
  const faqs = [
    {
      id: "what-is",
      question: "What is Visorithm?",
      answer:
        "Visorithm is an interactive platform designed for visualizing and learning about various algorithms and data structures through animated visualizations and real-time comparisons.",
    },
    {
      id: "race-mode",
    ...
    },
    {
      ...
      answer:
        "Yes! Visorithm is designed to be educational for all levels. Beginners can learn visually how algorithms work, while advanced users can compare performance characteristics and analyze algorithmic complexity.",
    },
    {
      id: "contributions",
  ...
  return (
    <div className="max-w-3xl px-4 py-8 mx-auto">
      ...
      <Seo
        ...
        description="Find answers to common questions about Visorithm, its features, and how to use the platform"
        keywords="algorithm FAQ, algorithm questions, Visorithm help, algorithm visualization help"
      />

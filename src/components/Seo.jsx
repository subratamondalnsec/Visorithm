...
const Seo = ({ title, description, keywords, image }) => {
  ...
  // TODO: Replace this placeholder with Visorithm's production domain.
  const baseUrl = "https://visorithm.example.com";
  const url = `${baseUrl}${location.pathname}`;

  // Default values
  const defaultTitle = "Visorithm - Interactive Algorithm Visualization";
  ...
  const pageTitle = title ? `${title} | Visorithm` : defaultTitle;

<div align="center">
  <!-- TODO: Replace public/logo.png with the final Visorithm logo. -->
  <img src="./public/logo.png" alt="Visorithm Logo" width="200">

  <h2>Interactive Algorithm Visualization Platform Built with React</h2>
...
Visorithm is a dynamic, interactive platform for comparing algorithm performance in real-time. Race different algorithms head-to-head to visualize their efficiency and learn about computational complexity in an engaging way.
...
```bash
# Clone repository
git clone https://github.com/subratamondalnsec/Visorithm.git
...
<div align="center">
  Made with ❤️ by <a href="https://github.com/subratamondalnsec">Subrata Mondal</a>
</div>
